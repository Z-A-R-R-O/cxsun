...
When local documentation context is used, end with a short source line. Restricted user mode should cite only user/policy docs. Super-admin mode can cite admin/system docs.
