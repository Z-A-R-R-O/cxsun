...
export const dashboardApps: DashboardAppDefinition[] = [
  ...
  withMenu({
    ...
    menuGroups: [
      ...
      { title: "Report", icon: BarChart3, items: [item("billing", "quotation-report", "Quotation Report", BarChart3), item("billing", "customer-statement", "Customer Statement", BarChart3), item("billing", "supplier-statement", "Supplier Statement", BarChart3), item("billing", "gst-report", "GST Report", BarChart3)] },
      ...
      { title: "Master", icon: PackageSearch, items: [item("billing", "contact", "Contact", UsersRound), item("billing", "product", "Product", PackageSearch), item("billing", "order", "Work Order", ShoppingBag)] },
      {
        ...
        items: [
          ...
          { ...item("billing", "others-common", "Others", Settings), items: [item("billing", "currency", "Currencies", CircleDollarSign), item("billing", "priority", "Priorities", ListChecks), item("billing", "payment-term", "Payment Terms", CreditCard), item("billing", "sales-type", "Sales Types", Tags), item("billing", "month", "Months", CalendarDays)] },
        ],
      },
