  ...
  withMenu({
    ...
    menuGroups: [
      ...
      { title: "Master", icon: PackageSearch, items: [item("billing", "contact", "Contact", UsersRound), item("billing", "product", "Product", PackageSearch), item("billing", "order", "Order", ShoppingBag)] },
      {
        ...
        icon: MapPin,
        items: [
          { ...item("billing", "location", "Location", MapPin), items: [item("billing", "country", "Countries", Globe2), item("billing", "state", "States", MapPin), item("billing", "district", "Districts", MapPin), item("billing", "city", "Cities", MapPin), item("billing", "pincode", "Pincodes", MapPin)] },
          { ...item("billing", "contacts-common", "Contacts", UsersRound), items: [item("billing", "contact-group", "Contact Groups", UsersRound), item("billing", "contact-type", "Contact Types", UsersRound), item("billing", "address-type", "Address Types", MapPin), item("billing", "bank-name", "Bank Names", Building2)] },
          { ...item("billing", "product-common", "Product", PackageSearch), items: [item("billing", "product-group", "Product Groups", Boxes), item("billing", "category", "Product Categories", Tags), item("billing", "product-type", "Product Types", PackageSearch), item("billing", "unit", "Units", Boxes), item("billing", "hsn-code", "HSN Codes", FileCog), item("billing", "tax", "Taxes", CircleDollarSign), item("billing", "brand", "Brands", Tags), item("billing", "colour", "Colours", Tags), item("billing", "size", "Sizes", Tags), item("billing", "style", "Styles", Tags)] },
          { ...item("billing", "orders-common", "Orders", ShoppingBag), items: [item("billing", "order-type", "Order Types", ShoppingBag), item("billing", "transport", "Transports", Truck), item("billing", "warehouse", "Warehouses", Warehouse), item("billing", "destination", "Destinations", MapPin), item("billing", "stock-rejection-type", "Stock Rejection Types", ReceiptText)] },
          { ...item("billing", "others-common", "Others", Settings), items: [item("billing", "currency", "Currencies", CircleDollarSign), item("billing", "payment-term", "Payment Terms", CreditCard), item("billing", "accounting-year", "Accounting Year", FileCog), item("billing", "month", "Months", FileCog)] },
        ],
      },
      { title: "Settings", icon: Settings, items: [item("billing", "settings", "Billing Settings", Settings), item("billing", "layout", "Billing Layout", FileCog), item("billing", "accounting-year", "Accounting Year", FileCog)] },
    ],
  }),
  withMenu({
    id: "ecommerce",
