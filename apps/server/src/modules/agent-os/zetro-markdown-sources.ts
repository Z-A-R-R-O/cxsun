...
export const zetroMarkdownSources: ZetroMarkdownSource[] = [
  ...
  {
    id: 'zetro-user-business-queries',
    label: 'ZETRO Business Queries',
    path: 'ZRO/ZETRO/docs/user/business-queries.md',
    purpose: 'User-safe examples for asking sales, purchase, and contact summary questions.',
    category: 'user-doc',
    audiences: ['public', 'user', 'admin'],
  },
  {
    id: 'zetro-policy-data-access',
    label: 'ZETRO Data Access Policy',
    path: 'ZRO/ZETRO/docs/policy/data-access.md',
    purpose: 'Strict tenant data boundary and read-only query policy for ZETRO.',
    category: 'policy-doc',
    audiences: ['public', 'user', 'admin'],
  },
  {
  ...
  {
    id: 'zetro-admin-review',
    label: 'ZETRO Super-Admin Review',
    path: 'ZRO/ZETRO/docs/admin/review.md',
    purpose: 'Super-admin review workflow for client questions and mapped query intents.',
    category: 'admin-doc',
    audiences: ['admin'],
  },
  {
  ...
  {
    id: 'zetro-system-query-tools',
    label: 'ZETRO Query Tools',
    path: 'ZRO/ZETRO/docs/system/query-tools.md',
    purpose: 'Read-only tenant query tool catalog and logging contract.',
    category: 'system-doc',
    audiences: ['admin', 'developer'],
  },
  {
